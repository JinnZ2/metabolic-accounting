...
DECLARED = [
    ...
    ("test_files", 55, "AUDIT_25",
     "55 test_*.py files in tests/ after AUDIT_25 added "
     "test_compliance_scorecard.py (the Smith-0/8-pattern "
     "tripwire on the new ComplianceScorecard data structure)"),
